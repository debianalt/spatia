...
def list_flood_files(client, prefix=FLOOD_PREFIX):
...
def download_blob(client, blob_name, output_dir=OUTPUT_DIR):
    """Download a single blob to output directory."""
...
def download_latest_flood(output_dir=OUTPUT_DIR, prefix=FLOOD_PREFIX):
    """
...
def main():
    ...
    parser.add_argument("--prefix", default=FLOOD_PREFIX,
