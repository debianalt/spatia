...
<style>
	...
	.welcome-terms-link { display: block; margin-top: 10px; color: rgba(255,255,255,0.6); font-size: 11px; text-decoration: none; text-align: center; padding: 6px 12px; border: 1px solid rgba(255,255,255,0.2); letter-spacing: 0.02em; transition: all 0.15s; }
	.welcome-terms-link:hover { color: #ffffff; border-color: rgba(255,255,255,0.5); }
