...
export function getParquetUrl(name: string): string {
	const busts: Record<string, string> = {
		hex_flood_risk: '?v=23',
		sat_environmental_risk: '?v=23',
		sat_climate_comfort: '?v=23',
		sat_green_capital: '?v=23',
		sat_change_pressure: '?v=23',
		sat_location_value: '?v=23',
		sat_agri_potential: '?v=23',
		sat_forest_health: '?v=23',
		sat_forestry_aptitude: '?v=23',
		sat_territorial_gap: '?v=23',
		sat_health_access: '?v=23',
		sat_education_gap: '?v=23',
