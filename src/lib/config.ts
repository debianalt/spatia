...
export const HEX_LAYER_REGISTRY: Record<string, HexLayerConfig> = {
	...
	climate_comfort: {
		...
		variables: [
			...
			{ col: 'c_mean_temp', labelKey: 'sat.climate.meanTemp', aggregation: 'mean' },
			...
			{ col: 'c_dewpoint', labelKey: 'sat.climate.dewpoint', aggregation: 'mean' },
			{ col: 'c_solar', labelKey: 'sat.climate.solar', aggregation: 'mean' },
			{ col: 'c_gdd', labelKey: 'sat.climate.gdd', aggregation: 'mean' },
			{ col: 'c_et', labelKey: 'sat.climate.et', aggregation: 'mean' },
		],
		primaryVariable: 'score',
	...
	agri_potential: {
		...
		variables: [
			...
			{ col: 'c_nitrogen', labelKey: 'sat.agri.nitrogen', aggregation: 'mean' },
			{ col: 'c_elevation', labelKey: 'sat.agri.elevation', aggregation: 'mean' },
			{ col: 'c_cec', labelKey: 'sat.agri.cec', aggregation: 'mean' },
		],
		primaryVariable: 'score',
		colorScale: 'green',
		aggregation: 'mean',
	...
	forestry_aptitude: {
		...
		variables: [
			...
			{ col: 'c_soc', labelKey: 'sat.forestry.soc', aggregation: 'mean' },
			...
			{ col: 'c_elevation', labelKey: 'sat.forestry.elevation', aggregation: 'mean' },
			{ col: 'c_gdd', labelKey: 'sat.forestry.gdd', aggregation: 'mean' },
		],
		primaryVariable: 'score',
		colorScale: 'green',
		aggregation: 'mean',
	...
	service_deprivation: {
		...
		variables: [
			...
			{ col: 'c_combustible', labelKey: 'sat.deprivation.combustible', aggregation: 'mean' },
			{ col: 'c_sin_techo', labelKey: 'sat.deprivation.sinTecho', aggregation: 'mean' },
		],
		primaryVariable: 'score',
		colorScale: 'flood',
		aggregation: 'mean',
	...
	health_access: {
		...
		variables: [
			...
			{ col: 'c_road_density', labelKey: 'sat.health.roadDensity', aggregation: 'mean' },
			{ col: 'c_nightlights', labelKey: 'sat.health.nightlights', aggregation: 'mean' },
			{ col: 'c_access_cities', labelKey: 'sat.health.accessCities', aggregation: 'mean' },
			{ col: 'c_dist_primary', labelKey: 'sat.health.distPrimary', aggregation: 'mean' },
		],
		primaryVariable: 'score',
		colorScale: 'flood',
		aggregation: 'mean',
