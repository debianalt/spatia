...
export function getParquetUrl(name: string): string {
	const busts: Record<string, string> = {
		hex_flood_risk: '?v=27',
		sat_environmental_risk: '?v=33',
		sat_climate_comfort: '?v=32',
		sat_green_capital: '?v=32',
		sat_change_pressure: '?v=33',
		sat_location_value: '?v=26',
		sat_agri_potential: '?v=31',
		sat_forest_health: '?v=33',
		...
		sat_climate_vulnerability: '?v=6',
		sat_carbon_stock: '?v=7',
		sat_pm25_drivers: '?v=4',
		sat_deforestation_dynamics: '?v=3',
		sat_productive_activity: '?v=6',
		sat_land_use: '?v=2',
...
export const HEX_LAYER_REGISTRY: Record<string, HexLayerConfig> = {
	...
	pm25_drivers: {
		...
		variables: [
			...
			{ col: 'c_fire', labelKey: 'sat.pm25.fire', aggregation: 'mean', unit: '/100' },
			{ col: 'c_climate', labelKey: 'sat.pm25.climate', aggregation: 'mean', unit: '/100' },
			{ col: 'c_terrain', labelKey: 'sat.pm25.terrain', aggregation: 'mean', unit: '/100' },
			{ col: 'c_vegetation', labelKey: 'sat.pm25.vegetation', aggregation: 'mean', unit: '/100' },
		],
		primaryVariable: 'score',
		colorScale: 'sequential',
		aggregation: 'mean',
