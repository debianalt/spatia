...
export const HEX_LAYER_REGISTRY: Record<string, HexLayerConfig> = {
	...
	service_deprivation: {
		...
		variables: [
			...
			{ col: 'c_sin_agua', labelKey: 'sat.deprivation.sinAgua', aggregation: 'mean' },
			{ col: 'c_sin_cloacas', labelKey: 'sat.deprivation.sinCloacas', aggregation: 'mean' },
			{ col: 'c_techo', labelKey: 'sat.deprivation.techo', aggregation: 'mean' },
	...
	education_flow: {
		...
		variables: [
			...
			{ col: 'c_youth_pct', labelKey: 'sat.eduFlow.youthPct', aggregation: 'mean' },
			{ col: 'c_female_headed', labelKey: 'sat.eduFlow.femaleHeaded', aggregation: 'mean' },
		],
		primaryVariable: 'score',
		colorScale: 'flood',
		aggregation: 'mean',
