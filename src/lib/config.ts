...
export function getParquetUrl(name: string): string {
	const busts: Record<string, string> = {
		hex_flood_risk: '?v=20',
		sat_environmental_risk: '?v=22',
		sat_climate_comfort: '?v=22',
		sat_green_capital: '?v=22',
		sat_change_pressure: '?v=22',
		sat_location_value: '?v=22',
		sat_agri_potential: '?v=22',
		sat_forest_health: '?v=22',
		sat_forestry_aptitude: '?v=22',
		sat_territorial_gap: '?v=22',
		sat_health_access: '?v=22',
		sat_education_gap: '?v=22',
		sat_territorial_types: '?v=22',
		sat_sociodemographic: '?v=22',
		sat_economic_activity: '?v=22',
		sat_accessibility: '?v=22',
		overture_scores: '?v=22',
