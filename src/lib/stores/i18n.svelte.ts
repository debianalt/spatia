...
const dict: Record<string, Record<Locale, string>> = {
	...
	'analysis.territorialProfile.desc': { es: 'Resumen multidimensiónal con 6 ejes temáticos', en: 'Multidimensiónal summary with 6 thematic axes', gn: "Mba'ekuaa 6 rape rupi" },
	...
	'data.source.overture': { es: 'Fuente: Overture Maps Foundation vía walkthru.earth (CC BY 4.0)', en: 'Source: Overture Maps Foundation vía walkthru.earth (CC BY 4.0)', gn: "Moñe'ẽha: Overture Maps Foundation (CC BY 4.0)" },
	...
	'scores.waterExposure': { es: 'Exposición hídrica', en: 'Water exposure', gn: 'Y' },
	'radio.densidad': { es: 'Densidad hab/km²', en: 'Pop. density/km²', gn: 'Densidad' },
	...
	'sat.change.desc': { es: 'Presión de cambio: tendencia de luces, expansión urbana, pérdida forestal, verdor y fuego', en: 'Change pressure: light trends, urban expansión, forest loss, greenness and fire', gn: "Oñemoambue" },
	...
	'sat.change.ghslChange': { es: 'Expansión urbana', en: 'Urban expansión', gn: "Táva tuicha" },
	...
	'sat.isolation.title': { es: '¿Dónde hay mayor aislamiento territorial?', en: 'Where is territorial isolation greatest?', gn: "Moõpa oĩve mombyry?" },
	...
	'sat.climVuln.heatStress': { es: 'Estres térmico', en: 'Heat stress', gn: "Aku hasýva" },
	'sat.climVuln.floodRisk': { es: 'Riesgo de inundación', en: 'Flood risk', gn: "Ysyry riesgo" },
	'sat.climVuln.waterStress': { es: 'Estres hídrico', en: 'Water stress', gn: "Y hasýva" },
	...
	'sat.prodAct.loss': { es: 'Conversion forestal', en: 'Forest conversión', gn: "Ka'aguy ojejapo" },
	...
	'sat.deforest.lossRate': { es: 'Tasa de pérdida (%/ano)', en: 'Loss rate (%/yr)', gn: "Okany (%/ary)" },
	...
	'sat.pm25pred.desc': { es: 'PM2.5 predicho por machine learning en ug/m3 con escenarios de fuego. Modelo entrenado con 25 años de datos satelitales (ACAG V6). Incluye bandas de excedencia OMS.', en: 'ML-predicted PM2.5 in ug/m3 with fire scenarios. Model trained on 25 years of satellite data (ACAG V6). Includes WHO exceedance bands.', gn: 'PM2.5 predicho' },
	...
	'sat.types.desc': { es: 'Clasificación metabolica: 5 tipos de cobertura basados en productividad ecosistemica, apropiación humana y dinámica de cambio (PCA + k-means)', en: 'Metabolic classification: 5 land cover types based on ecosystem productivity, human appropriation and change dynamics (PCA + k-means)', gn: "5 yvy lája" },
	...
	'sat.types.treecover': { es: 'Cobertura arbórea', en: 'Tree cover', gn: "Ka'aguy" },
	'sat.types.fracTrees': { es: 'Fraccion arbórea', en: 'Tree fraction', gn: "Ka'aguy %" },
	'sat.types.fracCrops': { es: 'Fraccion cultivos', en: 'Crop fraction', gn: "Temity %" },
	'sat.types.fracBuilt': { es: 'Fraccion construida', en: 'Built fraction', gn: "Oga %" },
	...
	'sat.types.ghslChange': { es: 'Expansion construida', en: 'Built-up expansión', gn: "Oga ipyahuve" },
	...
	'analysis.agriculturalLand.desc': { es: 'Superficies de uso agrícola, hortícola y gestiónado (Overture Maps)', en: 'Agricultural, horticultural and managed land surfaces (Overture Maps)', gn: "Yvy temitỹ, kokue ha oñangarekóva" },
	...
	'analysis.catastro.implicationsBody': {
		...
		en: 'The number of new parcels in the last 90 days indicates real estate pressure on each area. High growth of urban parcels may signal urban expansión, service demand and the need for planning.',
	...
	'analysis.flood.methodScore': {
		...
		en: 'Composite index 0–100: geometric mean of PCA-validated components (histórical presence, year-to-year recurrence, current extent). Sources: JRC Global Surface Water + Sentinel-1 SAR. An area permanently on a river scores high; a dry area with current flooding also scores high.',
	...
	'analysis.flood.howToReadBody': {
		...
		en: 'Colours represent flood risk per area, combining histórical water presence (JRC, 1984–2021) and current flood detection (Sentinel-1 SAR). Dark blue = low risk; yellow = medium risk; red = high risk. Select a department to view parcel-level detail.',
	...
	'analysis.flood.howToReadDeptBody': {
		...
		en: 'Each cadastral parcel is coloured by its flood risk. Click a parcel for its detailed score, including histórical water presence, year-to-year recurrence and current flood extent. You can select multiple parcels to compare them.',
	...
	'lasso.hint': { es: 'Dibujá una zona arrastrando sobre el mapa. El cálculo tarda unos segúndos.', en: 'Draw a zone by dragging on the map. Calculation takes a few seconds.', gn: "Embosako'i zona mapa ári. Ohasa segúndos." },
	...
	'side.welcome.desc': {
		...
		en: 'Geospatial analysis platform integrating hundreds of satellite, census and cadastral sources, continuously and automátically updated, for Misiones province, Argentina.',
	...
	'eudr.what.penalty_desc': { es: 'Las multas pueden alcanzar el 4% de la facturación anual del importador en la UE, más confiscación de mercadería y exclusión de licitaciones.', en: 'Fines can reach 4% of the importer\'s annual EU-wide turnover, plus confiscation of goods and exclusión from public procurement.', gn: 'EUDR' },
