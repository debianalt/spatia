...
const dict: Record<string, Record<Locale, string>> = {
	...
	'sat.catH3.title':   { es: '¿Dónde se subdivide el territorio?', en: 'Where is land being subdivided?', gn: "Moõpa yvy oñembokoha?" },
	'sat.catH3.desc':    { es: 'Variación mensual de parcelas catastrales: nuevas (subdivisión) y eliminadas (fusión). Fuente: Catastro Misiones WFS, actualización automática mensual.', en: 'Monthly variation in cadastral parcels: new (subdivision) and removed (merger). Source: Catastro Misiones WFS, automatic monthly update.', gn: "Moambue yvy padrón arambýpe" },
	'sat.catH3.added':   { es: 'Parcelas nuevas (90d)', en: 'New parcels (90d)', gn: "Yvy pyahu" },
	'sat.catH3.removed': { es: 'Parcelas eliminadas (90d)', en: 'Removed parcels (90d)', gn: "Yvy okañy" },
	'sat.catH3.total':   { es: 'Total de parcelas', en: 'Total parcels', gn: "Yvy mba'e" },
	'legend.catH3.low':  { es: 'Fusión / eliminación', en: 'Merger / removal', gn: "Yvy oñemboyjua" },
	'legend.catH3.high': { es: 'Subdivisión activa', en: 'Active subdivision', gn: "Yvy oñembokoha" },
