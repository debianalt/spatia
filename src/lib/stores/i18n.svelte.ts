...
const dict: Record<string, Record<Locale, string>> = {
	...
	'temporal.hint.current': { es: 'Ultimos 6 meses. Fuente: MODIS, CHIRPS, ERA5, VIIRS.', en: 'Last 6 months. Source: MODIS, CHIRPS, ERA5, VIIRS.', gn: "6 jasy paha" },
	'temporal.hint.baseline': { es: 'Promedio 2019-2021 (pre-cambio). Mismas fuentes satelitales.', en: 'Average 2019-2021 (pre-change). Same satellite sources.', gn: "2019-2021 media" },
