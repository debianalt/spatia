...
const dict: Record<string, Record<Locale, string>> = {
	...
	'legend.green.low': { es: 'Menor productividad', en: 'Less productive', gn: 'Michĩ ka\'aguy' },
	'legend.green.high': { es: 'Mayor productividad', en: 'More productive', gn: 'Tuicha ka\'aguy' },
	...
	'legend.locValue.low': { es: 'Peor ubicación', en: 'Worse location', gn: 'Michĩ valor' },
	'legend.locValue.high': { es: 'Mejor ubicación', en: 'Better location', gn: 'Tuicha valor' },
	...
	'legend.forestry.low': { es: 'Baja similitud biofísica', en: 'Low biophysical similarity', gn: "Michĩ ojoguáva" },
	'legend.forestry.high': { es: 'Alta similitud biofísica', en: 'High biophysical similarity', gn: "Tuicha ojoguáva" },
	...
	'analysis.coverage.pending': { es: 'próximamente', en: 'Coming soon', gn: 'Oguerahátama' },
	...
	'radio.densidad.pctl': { es: 'Densidad (pctl)', en: 'Density (pctl)', gn: 'Densidad (pctl)' },
	'radio.nbi.pctl': { es: 'NBI (pctl)', en: 'UBN (pctl)', gn: 'NBI (pctl)' },
	'radio.hacinamiento.pctl': { es: 'Hacinamiento (pctl)', en: 'Overcrowding (pctl)', gn: 'Hacinamiento (pctl)' },
	'radio.propietario.pctl': { es: 'Propietarios (pctl)', en: 'Homeowners (pctl)', gn: 'Propietario (pctl)' },
	'radio.tamHogar.pctl': { es: 'Hogar (pctl)', en: 'Household size (pctl)', gn: 'Hogar (pctl)' },
	'radio.computadora.pctl': { es: 'Computadora (pctl)', en: 'Computer (pctl)', gn: 'Computadora (pctl)' },
	...
	'sat.envRisk.deforest': { es: 'Pérdida de bosque', en: 'Forest loss', gn: "Ka'aguy jepe'a" },
	'sat.envRisk.thermal': { es: 'Amplitud térmica diaria', en: 'Daily thermal amplitude', gn: "Aku ha ro'y" },
	'sat.envRisk.slope': { es: 'Pendiente del terreno', en: 'Terrain slope', gn: "Yvy sa'i" },
	'sat.envRisk.hand': { es: 'Altura sobre drenaje', en: 'Height above drainage', gn: "Yvatekue y ári" },
	...
	'sat.climate.heatDay': { es: 'Temperatura diurna', en: 'Daytime temperature', gn: "Aku ára" },
	'sat.climate.heatNight': { es: 'Temperatura nocturna', en: 'Night temperature', gn: "Aku pyharépe" },
	'sat.climate.precip': { es: 'Precipitación anual', en: 'Annual rainfall', gn: 'Ama' },
	...
	'sat.climate.waterStress': { es: 'Déficit hídrico', en: 'Water deficit', gn: 'Y kangy' },
	...
	'sat.green.title': { es: '¿Qué tan productiva es la vegetación?', en: 'How productive is the vegetation?', gn: "Mba'eichapa oikuaa ka'aguy?" },
	'sat.green.desc': { es: 'Productividad vegetal: verdor estacional, área foliar, fracción arbórea y productividad primaria', en: 'Vegetation productivity: seasonal greenness, leaf area, tree fraction and primary productivity', gn: "Ka'aguy ñemoñare" },
	'sat.green.score': { es: 'Score de productividad', en: 'Productivity score', gn: 'Score' },
	'sat.green.ndvi': { es: 'Verdor satelital', en: 'Satellite greenness', gn: "Hovyũ" },
	'sat.green.treecover': { es: 'Cobertura arbórea', en: 'Tree cover 2000', gn: "Yvyra" },
	'sat.green.npp': { es: 'Productividad primaria', en: 'Primary productivity', gn: 'NPP' },
	'sat.green.lai': { es: 'Área foliar', en: 'Leaf area index', gn: 'LAI' },
	'sat.green.vcf': { es: 'Fracción arbórea', en: 'Tree cover fraction', gn: 'VCF' },
	'sat.green.type': { es: 'Tipo de productividad', en: 'Productivity type', gn: 'Laja' },
	...
	'sat.change.viirsLevel': { es: 'Iluminación nocturna', en: 'Night-time illumination', gn: "Tesa'y" },
	'sat.change.ndviLevel': { es: 'Verdor medio', en: 'Mean greenness', gn: "Hovyũ mbyte" },
	'sat.change.fireAnnual': { es: 'Fuego anual', en: 'Annual fire', gn: 'Tata' },
	...
	'sat.locValue.access20k': { es: 'Acceso a ciudad 20 mil hab.', en: 'Access to 20k city', gn: "Tape táva 20k" },
	'sat.locValue.healthcare': { es: 'Acceso a salud', en: 'Healthcare access', gn: 'Tasyo' },
	'sat.locValue.nightlights': { es: 'Actividad económica (luces)', en: 'Economic activity (lights)', gn: "Tesa'y" },
	'sat.locValue.slope': { es: 'Pendiente del terreno', en: 'Terrain slope', gn: "Yvy sa'i" },
	'sat.locValue.roadDist': { es: 'Distancia a ruta pavimentada', en: 'Paved road distance', gn: "Tape mombyry" },
	...
	'sat.agri.soc': { es: 'Carbono orgánico del suelo', en: 'Soil organic carbon', gn: 'Carbono' },
	'sat.agri.ph': { es: 'pH óptimo', en: 'Optimal pH', gn: "pH porã" },
	'sat.agri.phOptimal': { es: 'pH óptimo', en: 'Optimal pH', gn: "pH porã" },
	'sat.agri.clay': { es: 'Contenido de arcilla', en: 'Clay content', gn: 'Ñaũ' },
	'sat.agri.precip': { es: 'Precipitación anual', en: 'Annual rainfall', gn: 'Ama' },
	'sat.agri.gdd': { es: 'Grados-día acumulados', en: 'Growing degree days', gn: "Aku mbytekue" },
	'sat.agri.slope': { es: 'Pendiente del terreno', en: 'Terrain slope', gn: "Yvy sa'i" },
	...
	'sat.forestH.ndviMean': { es: 'Verdor medio', en: 'Mean greenness', gn: "Hovyũ mbyte" },
	'sat.forestH.lossRatio': { es: 'Pérdida arbórea relativa', en: 'Relative tree loss', gn: "Okañy ratio" },
	'sat.forestH.fire': { es: 'Frecuencia de fuego', en: 'Fire frequency', gn: 'Tata' },
	'sat.forestH.gpp': { es: 'Productividad fotosintética', en: 'Photosynthetic productivity', gn: 'GPP' },
	...
	'sat.soilW.precipitation': { es: 'Precipitación anual (CHIRPS)', en: 'Annual precipitation (CHIRPS)', gn: "Ama ary" },
	'sat.soilW.actualEt': { es: 'Evapotranspiración real (MODIS)', en: 'Actual evapotranspiration (MODIS)', gn: "Y okakuaa porã" },
	'sat.soilW.type': { es: 'Tipo hídrico', en: 'Water type', gn: 'Y laja' },
	'sat.soilW.typeLabel': { es: 'Clasificación', en: 'Classification', gn: 'Clasificación' },
	'legend.soilW.low': { es: 'Suelo seco / poca capacidad', en: 'Dry soil / low capacity', gn: "Yvy ko'ẽ" },
	'legend.soilW.high': { es: 'Suelo húmedo / alta capacidad', en: 'Moist soil / high capacity', gn: "Yvy yvytu porã" },
	'sat.forestry.title': { es: '¿Qué zonas se parecen a las que ya tienen plantaciones forestales?', en: 'Which areas resemble those that already have forestry plantations?', gn: "Mba'e tenda ojogua umi ka'aguy oĩmava rendápe?" },
	'sat.forestry.desc': { es: 'Modelo SDM: probabilidad de condiciones biofísicas similares a donde ya prospera la silvicultura en Misiones. Calibrado con MapBiomas. Excluye agua, urbano y bosque nativo maduro.', en: 'SDM model: probability of biophysical conditions similar to where forestry plantations already thrive in Misiones. Calibrated on MapBiomas. Excludes water, urban and mature native forest.', gn: "Ka'aguy modelo" },
	...
	'sat.forestry.clay': { es: 'Arcilla (%)', en: 'Clay (%)', gn: 'Ñaũ' },
	'sat.forestry.precip': { es: 'Precipitación anual (mm)', en: 'Annual rainfall (mm)', gn: 'Ama' },
	'sat.forestry.waterDeficit': { es: 'Déficit hídrico', en: 'Water deficit', gn: "Y ho'o" },
	'sat.forestry.frostDays': { es: 'Días de helada', en: 'Frost days', gn: "Ára ro'y" },
	'sat.forestry.slope': { es: 'Pendiente (°)', en: 'Slope (°)', gn: "Yvy sa'i" },
	'sat.forestry.roadDist': { es: 'Distancia a ruta', en: 'Road distance', gn: "Tape mombyry" },
	'sat.forestry.access50k': { es: 'Acceso a ciudad 50 mil hab.', en: 'Access to 50k city', gn: "Tape táva 50k" },
	...
	'sat.deprivation.nbi': { es: 'Hogares con NBI', en: 'Households with UBN', gn: 'NBI' },
	...
	'sat.isolation.roadDist': { es: 'Distancia a ruta', en: 'Road distance', gn: "Tape gotyo" },
	'sat.isolation.roadDensity': { es: 'Densidad vial', en: 'Road density', gn: "Tape heta" },
	'sat.isolation.nightlights': { es: 'Actividad nocturna', en: 'Night-time activity', gn: "Tesa'y" },
	...
	'sat.health.time': { es: 'Tiempo al centro de salud', en: 'Time to healthcare facility', gn: "Tasyo tape" },
	'sat.health.coverage': { es: 'Cobertura de salud', en: 'Health coverage', gn: "Tasyo rehegua" },
	'sat.health.nbi': { es: 'Hogares con NBI', en: 'Households with UBN', gn: 'NBI' },
	...
	'sat.eduCap.secondaryPlus': { es: 'Secundario completo o más', en: 'Secondary or higher', gn: "Mokõiha+" },
	...
	'sat.eduFlow.dropoutPrimary': { es: 'Inasistencia 6-12 años', en: 'Dropout 6-12 yrs', gn: "Oheja 6-12" },
	'sat.eduFlow.dropoutSecondary': { es: 'Inasistencia 13-18 años', en: 'Dropout 13-18 yrs', gn: "Oheja 13-18" },
	...
	'sat.climVuln.floodRisk': { es: 'Riesgo de inundación', en: 'Flood risk', gn: "Ysyry riesgo" },
	'sat.climVuln.waterStress': { es: 'Estrés hídrico', en: 'Water stress', gn: "Y hasýva" },
	'sat.climVuln.fireFreq': { es: 'Frecuencia de fuego', en: 'Fire frequency', gn: "Tata jevy" },
	'sat.climVuln.forestLoss': { es: 'Pérdida forestal', en: 'Forest loss', gn: "Ka'aguy okañy" },
	'sat.climVuln.vegetationInv': { es: 'Desprotección vegetal', en: 'Vegetation exposure', gn: "Ka'a'ỹ" },
	'sat.climVuln.isolation': { es: 'Aislamiento', en: 'Isolation', gn: "Mombyry" },
	'sat.climVuln.deprivation': { es: 'Privación de servicios', en: 'Service deprivation', gn: "Mba'e'ỹ" },
	...
	// ── Productive Activity ──
	'sat.prodAct.title': { es: '¿Dónde se concentra la actividad económica?', en: 'Where is economic activity concentrated?', gn: "Moope tembiapo economico oime? (Misiones)" },
	...
	'sat.deforest.lossRate': { es: 'Tasa de pérdida (%/año)', en: 'Loss rate (%/yr)', gn: "Okany (%/ary)" },
	'sat.deforest.cumulative': { es: 'Pérdida acumulada (%)', en: 'Cumulative loss (%)', gn: "Opavave okany (%)" },
	...
	'legend.landUse.low': { es: 'Tipo de cobertura 1', en: 'Cover type 1', gn: "Laja 1" },
	'legend.landUse.high': { es: 'Tipo de cobertura 6', en: 'Cover type 6', gn: "Laja 6" },
	// ── PM2.5 Predicted ──
	...
	'sat.types.score': { es: 'Score territorial', en: 'Territorial score', gn: 'Score' },
	'sat.types.typeLabel': { es: 'Clasificación', en: 'Classification', gn: 'Clasificación' },
	'legend.types.low': { es: 'Natural', en: 'Natural', gn: "Ka'aguy" },
	'legend.types.high': { es: 'Antrópico', en: 'Anthropic', gn: 'Tava' },
	...
	'sat.landUse.desc': { es: 'Tipo de cobertura dominante por hexágono: selva nativa, cultivos, pastizal, agua, humedal y urbano (MapBiomas Landsat 30m, 2022)', en: 'Dominant land cover type per hexagon: native forest, crops, pasture, water, wetland and urban (MapBiomas Landsat 30m, 2022)', gn: "Yvy jepuru: ka'aguy, temity, pasto, y, táva" },
	'sat.landUse.score': { es: 'Tipo de cobertura', en: 'Cover type', gn: 'Score' },
	'sat.landUse.type': { es: 'Tipo', en: 'Type', gn: 'Laja' },
	'sat.landUse.typeLabel': { es: 'Tipo de cobertura', en: 'Cover type', gn: 'Laja' },
	...
	'sat.landUse.grassland': { es: 'Pastizal natural (%)', en: 'Natural grassland (%)', gn: 'Pasto' },
	'sat.landUse.wetland': { es: 'Humedal (%)', en: 'Wetland (%)', gn: "Yvy y" },
	'sat.landUse.urban': { es: 'Urbano (%)', en: 'Urban (%)', gn: 'Tava' },
	'sat.landUse.water': { es: 'Agua (%)', en: 'Water (%)', gn: 'Y' },
	'sat.landUse.mosaic': { es: 'Mosaico agropecuario (%)', en: 'Agricultural mosaic (%)', gn: 'Mosaiko' },
	'sat.landUse.bare': { es: 'Suelo desnudo (%)', en: 'Bare soil (%)', gn: "Yvy ñu'ã" },
