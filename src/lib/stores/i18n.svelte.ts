...
const dict: Record<string, Record<Locale, string>> = {
	...
	'scores.paving': { es: 'Pavimentacion', en: 'Paving', gn: 'Tape' },
	...
	'scores.waterExposure': { es: 'Exposicion hidrica', en: 'Water exposure', gn: 'Y' },
	...
	'trade.eudr.analysis_desc': { es: 'Verificacion de deforestacion para parcelas de produccion (Hansen GFC 30 m + MODIS fire)', en: 'Deforestation verification for production plots (Hansen GFC 30m + MODIS fire)', gn: 'EUDR' },

	// ── Temporal toggle ──
	'temporal.current': { es: 'Actual', en: 'Current', gn: "Ko'ãga" },
	'temporal.baseline': { es: 'Linea Base', en: 'Baseline', gn: 'Base' },
	...
	'temporal.hint.baseline': { es: 'Periodo de referencia historico. Mismas fuentes satelitales.', en: 'Historical reference period. Same satellite sources.', gn: "Ymaguare" },
	'temporal.hint.delta': { es: 'Diferencia actual vs linea base. Rojo = empeoro, verde = mejoro.', en: 'Current minus baseline. Red = worsened, green = improved.', gn: "Moambue actual vs base" },
	// Per-layer temporal hints
	'temporal.hint.deforestation_dynamics.current': { es: 'Tasa de deforestacion 2015-2024. Fuente: Hansen/Landsat.', en: 'Deforestation rate 2015-2024. Source: Hansen/Landsat.', gn: "2015-2024 okany" },
	'temporal.hint.deforestation_dynamics.baseline': { es: 'Tasa de deforestacion 2001-2010 (pre-OTBN). Fuente: Hansen/Landsat.', en: 'Deforestation rate 2001-2010 (pre-OTBN). Source: Hansen/Landsat.', gn: "2001-2010 okany" },
	...
	'sat.climVuln.exposure': { es: 'Exposicion', en: 'Exposure', gn: "Oñeme'ẽva" },
	...
	'sat.climVuln.heatStress': { es: 'Estres termico', en: 'Heat stress', gn: "Aku hasýva" },
	...
	'sat.deforest.title': { es: '¿Como avanza la deforestacion?', en: 'How is deforestation progressing?', gn: "Mba'eichapa ka'aguy okany?" },
	'sat.deforest.desc': { es: 'Dinamica de deforestacion observada (Hansen/Landsat 2001-2024). Tasa de perdida forestal anual, acumulada, y cambio respecto a la linea base (2001-2010).', en: 'Observed deforestation dynamics (Hansen/Landsat 2001-2024). Annual forest loss rate, cumulative, and change from baseline (2001-2010).', gn: "Ka'aguy okany 2001-2024" },
	'sat.deforest.type': { es: 'Presion', en: 'Pressure', gn: 'Presion' },
	'sat.deforest.typeLabel': { es: 'Nivel de presion', en: 'Pressure level', gn: 'Presion' },
	...
	'legend.deforest.low': { es: 'Baja presion de deforestacion', en: 'Low deforestation pressure', gn: "Michimi" },
	'legend.deforest.high': { es: 'Alta presion de deforestacion', en: 'High deforestation pressure', gn: "Tuicha" },
	// ── PM2.5 Predicted ──
	'sat.pm25pred.title': { es: '¿Cuál es la calidad del aire predicha?', en: 'What is the predicted air quality?', gn: "Mba'eichapa tataendy?" },
	'sat.pm25pred.desc': { es: 'PM2.5 predicho por machine learning en ug/m3 con escenarios de fuego. Modelo entrenado con 25 anos de datos satelitales (ACAG V6). Incluye bandas de excedencia OMS.', en: 'ML-predicted PM2.5 in ug/m3 with fire scenarios. Model trained on 25 years of satellite data (ACAG V6). Includes WHO exceedance bands.', gn: 'PM2.5 predicho' },
	'sat.pm25pred.type': { es: 'Banda OMS', en: 'WHO band', gn: 'OMS' },
	'sat.pm25pred.typeLabel': { es: 'Clasificacion OMS', en: 'WHO classification', gn: 'OMS' },
	...
	'sat.types.fracTrees': { es: 'Fraccion arborea', en: 'Tree fraction', gn: "Ka'aguy %" },
	...
	'sat.types.deforest': { es: 'Deforestacion', en: 'Deforestation', gn: "Ka'aguy jepe'a" },
