...
const dict: Record<string, Record<Locale, string>> = {
	...
	'sat.types.score': { es: 'Score territorial', en: 'Territorial score', gn: 'Score territorial' },
	...
	'section.territorialProfile': { es: 'Perfil territorial', en: 'Territorial profile', gn: "Yvy rekokatu" },
	...
	'analysis.scores.type': { es: 'Tipo territorial', en: 'Territorial type', gn: 'Tipo' },
	...
	'sat.envRisk.title': { es: '¿Es seguro vivir acá? (Misiones)', en: 'Is it safe to live here? (Misiones)', gn: "Iporãpa oñeiko ko'ápe?" },
	...
	'sat.locValue.title': { es: '¿Cuánto vale esta localización? (Misiones)', en: 'How valuable is this location? (Misiones)', gn: "Mboy valépa ko yvy?" },
	...
	'sat.forestry.title': { es: 'Aptitud edafoclimática para silvicultura (Misiones)', en: 'Edaphoclimatic aptitude for silviculture (Misiones)', gn: "Yvy iporãva ka'aguy mbojaru haguã (Misiones)" },
	...
	'sat.isolation.title': { es: '¿Cuán aislado está este lugar? (Misiones)', en: 'How isolated is this place? (Misiones)', gn: "Mombyrypa ko yvy?" },
	...
	'sat.types.desc': { es: 'Clasificacion metabolica: 5 tipos territoriales basados en productividad ecosistemica, apropiacion humana y dinamica de cambio (PCA + k-means)', en: 'Metabolic classification: 5 territorial types based on ecosystem productivity, human appropriation and change dynamics (PCA + k-means)', gn: "5 yvy lája" },
	'sat.types.type': { es: 'Tipo territorial', en: 'Territorial type', gn: "Yvy lája" },
	...
	// ── Territorial Scores ──
	'analysis.scores.title': { es: '¿Qué zonas están mejor consolidadas? (Misiones)', en: 'Which areas are best consolidated? (Misiones)', gn: "Mba'e yvýpa oĩporãvéva?" },
	...
	'side.welcome.lens.vivir.items': { es: 'Riesgo hídrico · Riesgo ambiental · Confort climático · Capital verde · Tipos territoriales', en: 'Flood risk · Environmental risk · Climate comfort · Green capital · Territorial types', gn: "Ysyry riesgo · Riesgo ambiental · Ara porã · Ka'aguy porã · Yvy laja" },
	'side.welcome.lens.invertir.items': { es: 'Perfil territorial · Actividad económica · Presión de cambio · Valor de localización', en: 'Territorial profile · Economic activity · Change pressure · Location value', gn: "Yvy rekokatu · Mba'apo económico · Presión cambio · Tendaguépe" },
	...
	'side.welcome.lens.servir.items': { es: 'Accesibilidad · Aislamiento · Brecha territorial · Acceso a salud · Brecha educativa', en: 'Accessibility · Isolation · Territorial gap · Health access · Education gap', gn: "Jejuhu · Oñondive'ỹ · Brecha territorial · Tesãi · Mbo'ehao" },
	...
	'side.welcome.footer.research': { es: 'Investigación aplicada en inteligencia territorial', en: 'Applied research in territorial intelligence', gn: "Investigación yvy rekokatu rehegua" },
