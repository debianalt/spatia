...
const dict: Record<string, Record<Locale, string>> = {
	...
	'temporal.hint.carbon_stock.current': { es: 'Biomasa aérea 2022 (ESA CCI Biomass v6, Mg/ha). Indicadores estáticos: GEDI L4B, SoilGrids SOC, Hansen treecover2000, GFW Flux.', en: 'Above-ground biomass 2022 (ESA CCI Biomass v6, Mg/ha). Static indicators: GEDI L4B, SoilGrids SOC, Hansen treecover2000, GFW Flux.', gn: "2022 AGB ESA CCI" },
	'temporal.hint.carbon_stock.baseline': { es: 'Biomasa aérea promedio 2018-2020 (ESA CCI Biomass v6). Misma fuente que "Actual"; se comparan 2022 vs promedio 2018-2020.', en: 'Above-ground biomass average 2018-2020 (ESA CCI Biomass v6). Same source as "Current"; compares 2022 vs 2018-2020 average.', gn: "2018-2020 AGB promedio" },
	'temporal.hint.carbon_stock.delta': { es: 'Cambio de biomasa aérea: 2022 vs promedio 2018-2020. Verde = rebrote o crecimiento; rojo = degradación o pérdida.', en: 'AGB change: 2022 vs 2018-2020 average. Green = regrowth/growth; red = degradation/loss.', gn: "Moambue AGB 2022 vs 2018-2020" },
