...
const dict: Record<string, Record<Locale, string>> = {
	...
	'sat.deprivation.techo': { es: 'Techo inadecuado', en: 'Inadequate roof', gn: "Óga yvate vai" },
	'sat.deprivation.piso': { es: 'Piso inadecuado', en: 'Inadequate floor', gn: "Yvy vai" },
	'sat.deprivation.combustible': { es: 'Combustible precario', en: 'Precarious fuel', gn: "Tata vai" },
	'sat.deprivation.hacinamiento': { es: 'Hacinamiento crítico', en: 'Critical overcrowding', gn: "Heta óga peteĩme" },
	...
	'sat.eduCap.noInstruction': { es: 'Sin instrucción', en: 'No schooling', gn: "Mbo'ehao'ỹ" },
	'sat.eduCap.onlyPrimary': { es: 'Solo primaria', en: 'Primary only', gn: "Mbo'ehao peteĩ" },
	'sat.eduCap.secondary': { es: 'Secundario completo', en: 'Secondary complete', gn: "Mokõiha" },
