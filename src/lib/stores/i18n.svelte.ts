...
const dict: Record<string, Record<Locale, string>> = {
	...
	// ── EMSA powerlines ──
	'emsa.title': { es: '¿Dónde llega la red eléctrica? (Misiones)', en: 'Where does the power grid reach? (Misiones)', gn: "Moõpa oguahẽ corriente?" },
	...
	'sat.envRisk.title': { es: '¿Qué riesgos ambientales hay en esta zona? (Misiones)', en: 'What environmental risks are in this area? (Misiones)', gn: "Mba'e mba'asypa oĩ ko yvýpe? (Misiones)" },
	...
	'sat.climate.title': { es: '¿Es confortable el clima? (Misiones)', en: 'Is the climate comfortable? (Misiones)', gn: "Iporãpa ára ko'ápe?" },
	...
	'sat.green.title': { es: '¿Hay verde acá? (Misiones)', en: 'Is there green here? (Misiones)', gn: "Oĩpa hovyũ ko'ápe?" },
	...
	'sat.change.title': { es: '¿Se está transformando esta zona? (Misiones)', en: 'Is this area transforming? (Misiones)', gn: "Oñemoambuépa ko yvy?" },
	...
	'sat.locValue.title': { es: '¿Qué tan bien ubicada está esta zona? (Misiones)', en: 'How well located is this area? (Misiones)', gn: "Iporãpa oĩhápe ko yvy? (Misiones)" },
	...
	'sat.agri.title': { es: '¿Qué potencial agrícola tiene? (Misiones)', en: 'What agricultural potential? (Misiones)', gn: "Mba'éichapa yvy temity?" },
	...
	'sat.forestry.title': { es: '¿Dónde hay condiciones edafoclimáticas para silvicultura? (Misiones)', en: 'Where are edaphoclimatic conditions suitable for silviculture? (Misiones)', gn: "Moõpa oĩ yvy iporãva ka'aguy mbojaru haguã? (Misiones)" },
	...
	'sat.deprivation.title': { es: '¿Dónde hay mayor carencia de servicios? (Misiones)', en: 'Where is service deprivation greatest? (Misiones)', gn: "Moõpa oĩve mba'e'ỹ?" },
	...
	'sat.isolation.title': { es: '¿Dónde hay mayor aislamiento territorial? (Misiones)', en: 'Where is territorial isolation greatest? (Misiones)', gn: "Moõpa oĩve mombyry?" },
	...
	'sat.health.title': { es: '¿Dónde faltan servicios de salud? (Misiones)', en: 'Where are health services lacking? (Misiones)', gn: "Moõpa oĩ'ỹ tasyo?" },
	...
	'sat.eduCap.title': { es: '¿Dónde hay menor capital educativo? (Misiones)', en: 'Where is education capital lowest? (Misiones)', gn: "Moõpa oĩ'ỹve mbo'ehao?" },
	...
	'sat.landUse.title': { es: '¿Qué uso de suelo tiene esta zona? (Misiones)', en: 'What land use does this area have? (Misiones)', gn: "Mba'éichapa ojepuru ko yvy?" },
	...
	'analysis.accessibility.title': { es: '¿Qué zonas están más aisladas? (Misiones)', en: 'Which areas are most isolated? (Misiones)', gn: "Mba'e yvýpa oĩ mombyryve?" },
	...
	'analysis.socio.title': { es: '¿Dónde son mayores las carencias sociales? (Misiones)', en: 'Where are social deprivations greatest? (Misiones)', gn: "Moõpa oĩ mba'e'ỹ tuichavéva?" },
	...
	'analysis.economic.title': { es: '¿Dónde se concentra la actividad económica? (Misiones)', en: 'Where is economic activity concentrated? (Misiones)', gn: "Moõpa oñembyaty mba'apo?" },
	...
	// ── Territorial Scores ──
	'analysis.scores.title': { es: '¿Dónde hay más infraestructura y servicios? (Misiones)', en: 'Where is there more infrastructure and services? (Misiones)', gn: "Moõpa oĩve mba'apo ha servicio?" },
