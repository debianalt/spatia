...
const dict: Record<string, Record<Locale, string>> = {
	...
	'analysis.catastro.h.agua': { es: 'Agua de red', en: 'Water access', gn: "Y oĩva" },
	'analysis.catastro.h.cloacas': { es: 'Cloacas', en: 'Sewerage', gn: "Ysyry guasu" },
	...
	'analysis.catastro.petalHint': { es: 'Línea punteada = promedio provincial', en: 'Dashed line = provincial average', gn: "Tape kyta = tetã mbytekue" },
