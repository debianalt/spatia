...
const dict: Record<string, Record<Locale, string>> = {
	...
	'analysis.catastro.h.agua': { es: 'Con agua de red', en: 'With water net.', gn: "Y oĩva" },
	'analysis.catastro.h.cloacas': { es: 'Con cloacas', en: 'With sewerage', gn: "Ysyry guasu oĩva" },
