...
const dict: Record<string, Record<Locale, string>> = {
	...
	'sat.forestH.title': { es: '¿Cuán sano está el bosque?', en: 'How healthy is the forest?', gn: "Iporãpa ka'aguy?" },
	'sat.forestH.desc': { es: 'Integridad forestal: tendencia NDVI, pérdida arbórea, fuego, productividad y transpiración', en: 'Forest integrity: NDVI trend, tree loss, fire, productivity and transpiration', gn: "Ka'aguy porã" },
	'sat.forestH.score': { es: 'Score forestal', en: 'Forest score', gn: 'Score' },
	...
	'sat.landUse.desc': { es: 'Cobertura y uso del suelo: bosque, cultivos, urbano, pasturas, agua y arbustos (Dynamic World 10m, Sentinel-2)', en: 'Land cover and use: forest, crops, urban, pasture, water and shrubs (Dynamic World 10m, Sentinel-2)', gn: "Yvy jepuru: ka'aguy, temity, táva, pasto, y ha ka'avo" },
	'sat.landUse.score': { es: 'Diversidad de uso', en: 'Use diversity', gn: 'Score' },
	'sat.landUse.trees': { es: 'Bosque', en: 'Trees', gn: "Ka'aguy" },
