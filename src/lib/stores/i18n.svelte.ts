...
const dict: Record<string, Record<Locale, string>> = {
	...
	'sat.eduCap.noPrimary': { es: 'Sin primaria completa', en: 'No primary', gn: "Mbo'ehao'ỹ" },
	'sat.eduCap.onlyPrimary': { es: 'Solo primaria', en: 'Primary only', gn: "Mbo'ehao peteĩ" },
	'sat.eduCap.onlySecondary': { es: 'Solo secundario', en: 'Secondary only', gn: "Mokõiha" },
	'sat.eduCap.tertiary': { es: 'Terciario', en: 'Tertiary', gn: "Mbohapy-ha" },
	...
	'sat.eduFlow.title': { es: '¿Dónde falla el sistema educativo? (Misiones)', en: 'Where is the education system failing? (Misiones)', gn: "Moõpa ndoikói mbo'ehao?" },
	'sat.eduFlow.desc': { es: 'Flujo educativo: inasistencia primaria y secundaria, embarazo adolescente, presión demográfica juvenil', en: 'Education flow: primary and secondary dropout, teen pregnancy, youth demographic pressure', gn: "Mbo'ehao flujo" },
